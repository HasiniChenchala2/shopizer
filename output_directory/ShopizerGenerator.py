...
class ShopizerGenerator(Generator):
    ...
    _charsets = {
        ...
        1: list(itertools.chain.from_iterable([range(32, 34), range(35, 92), range(93, 127)])),
        2: list(itertools.chain.from_iterable([range(49, 58)])),
    }
